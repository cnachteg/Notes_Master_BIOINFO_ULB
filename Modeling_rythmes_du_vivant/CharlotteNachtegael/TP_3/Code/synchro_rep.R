synchro_rep<-function(run=5,omega=50){
  colo=c(rainbow(10))
  plot(1,type='n',xlim=c(0,100),ylim=c(0,5000),xlab='Time', ylab='P1')
  for (i in 1:run){
  #parameters
  a0=0*omega
  a1=100*omega
  ...
  #initial conditions
  m1=round(41.57848*omega);
  m2=round(3.513699*omega);
  m3=round(1.917003*omega);
  p1=round(41.71645*omega);
  p2=round(4.375961*omega);
  p3=round(1.496348*omega);
