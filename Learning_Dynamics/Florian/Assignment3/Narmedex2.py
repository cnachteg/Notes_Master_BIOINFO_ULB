...
def action_reward(action):
    if action == 0:
        result = random.normalvariate(2.3,1.2)
    elif action == 1:
        result = random.normalvariate(2.1,1.8)
    elif action == 2:
        result = random.normalvariate(1.5,4)
    elif action == 3:
        result = random.normalvariate(1.3,0.8)
    return result
        ...
        for t in range(1,times):
            ...
            if proba == "exploitation":
                for i in random.sample(range(len(Qalast)),len(Qalast)): #choisir au random un Q max (en cas d'egalite avec les voisins)
                    ...
                    choice= Qalast.index(max(Qalast))
...
# ***************************Epsilon et tau en fonction du temps***********************************
#             ***************************************************************
#             ***************************************************************
